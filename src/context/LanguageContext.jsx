...
const translations = {
  en: {
    ...
    confirmDeleteAccount: 'Delete your account permanently? This cannot be undone.',
    enterPasswordConfirm: 'Enter your password to confirm:',
    incorrectPasswordAccountNotDeleted: 'Incorrect password. Account not deleted.',
  ...
  ar: {
    ...
    enterNewUsername: 'أدخل اسم مستخدم جديد:',
    ...
    confirmDeleteAccount: 'هل تريد حذف حسابك نهائيًا؟ لا يمكن التراجع عن هذا الإجراء.',
    enterPasswordConfirm: 'أدخل كلمة المرور للتأكيد:',
    incorrectPasswordAccountNotDeleted: 'كلمة مرور غير صحيحة. لم يتم حذف الحساب.',
